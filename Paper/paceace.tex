...
\newcommand{\APW}{\emph{APW}}
\newcommand{\VPW}{\emph{VPW}}
\newcommand{\APH}{\emph{APH}}
\newcommand{\VPH}{\emph{VPH}}
...
die due to some failure in the heart [1]. A healthy heart
...
the heart requires stimulation [2]. The devices utilize
...
beats within an ECG signal [3,4]. However, current
...
crucial for Cardiac Resynchronization Therapy (CRT)
[5]. In fact, up to 30\% of patients with pacemakers do
not respond to CRT implemented by current pacemakers
[5].
...
$f[n]$. Figure~\ref{fig:fwr} illustrates this concept.
\begin{figure}
	\centering
	\begin{tikzpicture}
		\begin{axis}[
...
algorithm [6]. The ventricular cluster will have a
...
found in Figure~\ref{fig:kmeans}.
