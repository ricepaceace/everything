...
\end{figure}
To efficiently learn parameters for the multiple wireless sensors and make beat detection more suitable for CRT,
...
by processing a few seconds of data sampled
at 1 kHz. \figurename~\ref{fig:singlebeat} shows how these parameters correspond to portions of the cardiac electrical signal.
