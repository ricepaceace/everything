...
\subsubsection{Precise Specification of $beats(threshold)$ using our Proposed Beat Detection Algorithm}
...
an algorithm that draws heavily from the ECG beat
...
with biological feasibility, we do not allow beats to
occur within .27 seconds of each other. Finally, we
...
cleans analog ECG data before it is digitized and used
...
simply processing 10 seconds of ECG data sampled at 1
...
We then applied our algorithm on 10 seconds of data
...
ventricular beats in an ECG signal in real time. Future
