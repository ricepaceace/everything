...
\begin{figure}
	...
	\begin{tikzpicture}
		...
		\end{axis}
	\end{tikzpicture}
	\caption{Graph of the function $\beta(\tau)$ on example CES data}
	\label{fig:beats}
\end{figure}
...
Because of the maximality of the flat interval $[i,j]$ and the monotonicity of $\beta(\tau)$, 
...
Similar logic applies to our choise of $\tau_{max}$.
