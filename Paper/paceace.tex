...
and stimulate muscle contraction properly. % TODO: The parallelism of this sentence is not right, but I don't see a good way to fix it
...
phase of the heartbeat and which part corresponds to % ???: Is phase the right word?
...
However, up to 30\% of patients with pacemakers do % TODO: up to?
not respond to CRT implemented by current pacemakers~\cite{multisite-crt}. %TODO: Do we know why this happens?
...
width of a ventricular peak (\VPW) within a CES % TODO: Do we want a figure here showing these parameters
...
be the centers of the ventricular and atrial clusters % TODO: replace center with mean?
...
results. %???: THis is a long sentence.
...
such that $beats(th_i)$ is biologically infeasible. %TODO: We had a better word than infeasible
...
approach to compute \VPW{} and \APW{} previously. % ???: Seems a little out of place
Next, define:
