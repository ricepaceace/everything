...
not respond to CRT implemented by current pacemakers ~\cite{multisite-crt}. %TODO: (Yamin: I dont think we know, but I also dont think its too big of a deal)
...
width of a ventricular peak (\VPW) within a signal % TODO: (Yamin: I think we do want a figure).
...
The next will explain our rational for constructing $w[n]$.Next, the algorithm 
...
cleans analog signal from the heart before it is digitized and used
