...
HD_PWD='/home/greg/everything/xilnx_design/cycle3/fullPrototype/fullPrototype.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log full_system_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source full_system_wrapper.tcl
