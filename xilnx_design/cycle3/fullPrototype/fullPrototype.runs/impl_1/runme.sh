...
HD_PWD='/home/greg/everything/xilnx_design/cycle3/fullPrototype/fullPrototype.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log full_system_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source full_system_wrapper.tcl -notrace
