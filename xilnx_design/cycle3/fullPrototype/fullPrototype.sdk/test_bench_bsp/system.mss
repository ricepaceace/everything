...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = Decision
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = Decision_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = Decision
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = Decision_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = Decision
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = Decision_2
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = Decision
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = Decision_3
END
...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = axi_max11100_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.0
 PARAMETER HW_INSTANCE = axi_max11100_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.0
 PARAMETER HW_INSTANCE = axi_max11100_2
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.0
 PARAMETER HW_INSTANCE = axi_max11100_3
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = ratDecision
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = ratDecision_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = ratDecision
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = ratDecision_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.1
 PARAMETER HW_INSTANCE = stim
END
