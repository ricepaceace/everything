...
#
# Generated by Vivado on Tue Feb 28 21:51:49 CST 2017
# IP Build 1577682 on Fri Jun  3 12:00:54 MDT 2016 
#
# usage: full_system.sh [-help]
# usage: full_system.sh [-lib_map_path]
# usage: full_system.sh [-noclean_files]
# usage: full_system.sh [-reset_run]
#
...
# executing this script. Please type 'full_system.sh -help' for more information.
#
...
# Design libraries
design_libs=(xil_defaultlib xpm processing_system7_bfm_v2_0_5 proc_common_v3_00_a axi_lite_ipif_v1_01_a axi_max11100_v1_00_a axi_lite_ipif_v3_0_4 lib_cdc_v1_0_2 interrupt_control_v3_1_4 axi_gpio_v2_0_11 lib_pkg_v1_0_2 axi_timer_v2_0_11 proc_sys_reset_v5_0_9 generic_baseblocks_v2_1_0 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_9 fifo_generator_v13_1_1 axi_data_fifo_v2_1_8 axi_crossbar_v2_1_10 axi_protocol_converter_v2_1_9)

# Simulation root library directory
sim_lib_dir="vcs"

# Script info
echo -e "full_system.sh - Script generated by export_simulation (Vivado v2016.2 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/full_system/ip/full_system_processing_system7_0_0/sim/full_system_processing_system7_0_0.v" \
  2>&1 | tee -a vlogan.log

  vhdlan -work proc_common_v3_00_a $vhdlan_opts \
    "$ref_dir/../../../ipstatic/proc_common_v3_00_a/family_support.vhd" \
    "$ref_dir/../../../ipstatic/proc_common_v3_00_a/pselect_f.vhd" \
    "$ref_dir/../../../ipstatic/proc_common_v3_00_a/proc_common_pkg.vhd" \
    "$ref_dir/../../../ipstatic/proc_common_v3_00_a/ipif_pkg.vhd" \
  2>&1 | tee -a vhdlan.log

  vhdlan -work axi_lite_ipif_v1_01_a $vhdlan_opts \
    "$ref_dir/../../../ipstatic/axi_lite_ipif_v1_01_a/address_decoder.vhd" \
    "$ref_dir/../../../ipstatic/axi_lite_ipif_v1_01_a/axi_lite_ipif.vhd" \
    "$ref_dir/../../../ipstatic/axi_lite_ipif_v1_01_a/slave_attachment.vhd" \
  2>&1 | tee -a vhdlan.log

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/full_system/ipshared/paceace/axi_max11100_v1_0/hdl/verilog/user_logic.v" \
  2>&1 | tee -a vlogan.log

  vhdlan -work axi_max11100_v1_00_a $vhdlan_opts \
    "$ref_dir/../../../bd/full_system/ipshared/paceace/axi_max11100_v1_0/hdl/vhdl/axi_max11100.vhd" \
  2>&1 | tee -a vhdlan.log

  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/full_system/ip/full_system_axi_max11100_0_0/sim/full_system_axi_max11100_0_0.vhd" \
    "$ref_dir/../../../bd/full_system/ip/full_system_axi_max11100_0_1/sim/full_system_axi_max11100_0_1.vhd" \
    "$ref_dir/../../../bd/full_system/ip/full_system_axi_max11100_0_2/sim/full_system_axi_max11100_0_2.vhd" \
    "$ref_dir/../../../bd/full_system/ip/full_system_axi_max11100_0_3/sim/full_system_axi_max11100_0_3.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/full_system/ip/full_system_axi_gpio_0_0/sim/full_system_axi_gpio_0_0.vhd" \
    "$ref_dir/../../../bd/full_system/ip/full_system_axi_gpio_1_0/sim/full_system_axi_gpio_1_0.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/full_system/ip/full_system_axi_timer_0_0/sim/full_system_axi_timer_0_0.vhd" \
  2>&1 | tee -a vhdlan.log

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/full_system/ipshared/xilinx.com/xlconcat_v2_1/xlconcat.v" \
    "$ref_dir/../../../bd/full_system/ip/full_system_xlconcat_0_0/sim/full_system_xlconcat_0_0.v" \
  2>&1 | tee -a vlogan.log
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/full_system/ip/full_system_rst_processing_system7_0_100M_0/sim/full_system_rst_processing_system7_0_100M_0.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/full_system/ip/full_system_xbar_0/sim/full_system_xbar_0.v" \
    "$ref_dir/../../../bd/full_system/hdl/full_system.v" \
    "$ref_dir/../../../../fullPrototype.srcs/sources_1/bd/full_system/ipshared/paceace/decision_v1_0/hdl/verilog/Decision_AXILiteS_s_axi.v" \
    "$ref_dir/../../../../fullPrototype.srcs/sources_1/bd/full_system/ipshared/paceace/decision_v1_0/hdl/verilog/Decision.v" \
    "$ref_dir/../../../../fullPrototype.srcs/sources_1/bd/full_system/ipshared/paceace/decision_v1_0/hdl/verilog/Decision_recentdatapoints_data.v" \
    "$ref_dir/../../../../fullPrototype.srcs/sources_1/bd/full_system/ipshared/paceace/decision_v1_0/hdl/verilog/Decision_recentVBools_data.v" \
    "$ref_dir/../../../bd/full_system/ip/full_system_Decision_0_4/sim/full_system_Decision_0_4.v" \
    "$ref_dir/../../../bd/full_system/ip/full_system_Decision_0_5/sim/full_system_Decision_0_5.v" \
    "$ref_dir/../../../bd/full_system/ip/full_system_Decision_0_6/sim/full_system_Decision_0_6.v" \
    "$ref_dir/../../../bd/full_system/ip/full_system_Decision_0_7/sim/full_system_Decision_0_7.v" \
  2>&1 | tee -a vlogan.log
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/full_system/ip/full_system_auto_pc_0/sim/full_system_auto_pc_0.v" \
  2>&1 | tee -a vlogan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.full_system xil_defaultlib.glbl -o full_system_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./full_system_simv $vcs_sim_opts -do simulate.do
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./full_system.sh -help\" for more information)\n"
        exit 1
      fi
...
reset_run()
{
  files_to_remove=(ucli.key full_system_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc full_system_simv.daidir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./full_system.sh -help\" for more information)\n"
    exit 1
  fi
