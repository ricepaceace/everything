...
`define AUTOTB_DUT      Decision
`define AUTOTB_DUT_INST AESL_inst_Decision
`define AUTOTB_TOP      apatb_Decision_top
`define AUTOTB_LAT_RESULT_FILE "Decision.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "Decision.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_Decision_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00

`define AESL_DEPTH_reset_A_V 1
`define AESL_DEPTH_reset_V_V 1
`define AESL_DEPTH_reset_params_V 1
`define AESL_DEPTH_athresh 1
`define AESL_DEPTH_vthresh 1
`define AESL_DEPTH_a_flip 1
`define AESL_DEPTH_v_flip 1
`define AESL_DEPTH_a_length 1
`define AESL_DEPTH_v_length 1
`define AESL_DEPTH_data 1
`define AUTOTB_TVIN_reset_A_V  "./c.Decision.autotvin_reset_A_V.dat"
`define AUTOTB_TVIN_reset_V_V  "./c.Decision.autotvin_reset_V_V.dat"
`define AUTOTB_TVIN_reset_params_V  "./c.Decision.autotvin_reset_params_V.dat"
`define AUTOTB_TVIN_athresh  "./c.Decision.autotvin_athresh.dat"
`define AUTOTB_TVIN_vthresh  "./c.Decision.autotvin_vthresh.dat"
`define AUTOTB_TVIN_a_flip  "./c.Decision.autotvin_a_flip.dat"
`define AUTOTB_TVIN_v_flip  "./c.Decision.autotvin_v_flip.dat"
`define AUTOTB_TVIN_a_length  "./c.Decision.autotvin_a_length.dat"
`define AUTOTB_TVIN_v_length  "./c.Decision.autotvin_v_length.dat"
`define AUTOTB_TVIN_data  "./c.Decision.autotvin_data.dat"
`define AUTOTB_TVIN_reset_A_V_out_wrapc  "./rtl.Decision.autotvin_reset_A_V.dat"
`define AUTOTB_TVIN_reset_V_V_out_wrapc  "./rtl.Decision.autotvin_reset_V_V.dat"
`define AUTOTB_TVIN_reset_params_V_out_wrapc  "./rtl.Decision.autotvin_reset_params_V.dat"
`define AUTOTB_TVIN_athresh_out_wrapc  "./rtl.Decision.autotvin_athresh.dat"
`define AUTOTB_TVIN_vthresh_out_wrapc  "./rtl.Decision.autotvin_vthresh.dat"
`define AUTOTB_TVIN_a_flip_out_wrapc  "./rtl.Decision.autotvin_a_flip.dat"
`define AUTOTB_TVIN_v_flip_out_wrapc  "./rtl.Decision.autotvin_v_flip.dat"
`define AUTOTB_TVIN_a_length_out_wrapc  "./rtl.Decision.autotvin_a_length.dat"
`define AUTOTB_TVIN_v_length_out_wrapc  "./rtl.Decision.autotvin_v_length.dat"
`define AUTOTB_TVIN_data_out_wrapc  "./rtl.Decision.autotvin_data.dat"
`define AUTOTB_TVOUT_ap_return  "./c.Decision.autotvout_ap_return.dat"
`define AUTOTB_TVOUT_ap_return_out_wrapc  "./impl_rtl.Decision.autotvout_ap_return.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 10001;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 13;
parameter LENGTH_reset_A_V = 1;
parameter LENGTH_reset_V_V = 1;
parameter LENGTH_reset_params_V = 1;
parameter LENGTH_athresh = 1;
parameter LENGTH_vthresh = 1;
parameter LENGTH_a_flip = 1;
parameter LENGTH_v_flip = 1;
parameter LENGTH_a_length = 1;
parameter LENGTH_v_length = 1;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.Decision.autotvout_ap_return.dat", "r");
    fp2 = $fopen("./impl_rtl.Decision.autotvout_ap_return.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.Decision.autotvout_ap_return.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.Decision.autotvout_ap_return.dat\"!");
    else begin
        $display("Comparing rtl.Decision.autotvout_ap_return.dat with impl_rtl.Decision.autotvout_ap_return.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
...
reg end_reset_A_V;
reg [31:0] size_reset_A_V;
reg [31:0] size_reset_A_V_backup;
reg end_reset_V_V;
reg [31:0] size_reset_V_V;
reg [31:0] size_reset_V_V_backup;
reg end_reset_params_V;
reg [31:0] size_reset_params_V;
reg [31:0] size_reset_params_V_backup;
reg end_athresh;
reg [31:0] size_athresh;
reg [31:0] size_athresh_backup;
reg end_vthresh;
reg [31:0] size_vthresh;
reg [31:0] size_vthresh_backup;
reg end_a_flip;
reg [31:0] size_a_flip;
reg [31:0] size_a_flip_backup;
reg end_v_flip;
reg [31:0] size_v_flip;
reg [31:0] size_v_flip_backup;
reg end_a_length;
reg [31:0] size_a_length;
reg [31:0] size_a_length_backup;
reg end_v_length;
reg [31:0] size_v_length;
reg [31:0] size_v_length_backup;
reg end_data;
reg [31:0] size_data;
