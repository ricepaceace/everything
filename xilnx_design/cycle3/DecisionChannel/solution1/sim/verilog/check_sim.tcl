...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.Decision.autotvin_reset_A_V.dat"
         "c.Decision.autotvin_reset_V_V.dat"
         "c.Decision.autotvin_reset_params_V.dat"
         "c.Decision.autotvin_athresh.dat"
         "c.Decision.autotvin_vthresh.dat"
         "c.Decision.autotvin_a_flip.dat"
         "c.Decision.autotvin_v_flip.dat"
         "c.Decision.autotvin_a_length.dat"
         "c.Decision.autotvin_v_length.dat"
         "c.Decision.autotvin_data.dat"
         "c.Decision.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.Decision.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
