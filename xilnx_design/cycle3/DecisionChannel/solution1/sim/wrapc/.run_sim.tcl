...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "Decision.autotvin.dat"
	set constFileTvOut       "Decision.autotvout.dat"
	set constFileHdlTvIn     "Decision.autohdltvin.dat"
	set constFileHdlTvOut    "Decision.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
