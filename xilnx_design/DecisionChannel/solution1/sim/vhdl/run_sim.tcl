...
if {[file isfile Decision.autotvin.dat]} {
	file delete -force Decision.autotvin.dat
}

if {[file isfile Decision.autotvout.dat]} {
	file delete -force Decision.autotvout.dat
}
