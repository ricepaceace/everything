set C_TypeInfoList {{ 
"Decision" : [[], {"return": [[], {"scalar": "short"}] }, [{"ExternC" : 0}], [ {"reset_A": [[],"0"] }, {"reset_V": [[],"0"] }, {"reset_params": [[],"0"] }, {"athresh": [[], {"scalar": "int"}] }, {"vthresh": [[], {"scalar": "int"}] }, {"a_flip": [[], {"scalar": "char"}] }, {"v_flip": [[], {"scalar": "char"}] }, {"a_length": [[], {"scalar": "unsigned int"}] }, {"v_length": [[], {"scalar": "unsigned int"}] }, {"data": [[], {"scalar": "short"}] }],[],""], 
"0": [ "dbool", {"typedef": [[[],"1"],""]}], 
"1": [ "ap_uint<1>", {"hls_type": {"ap_uint": [[[[], {"scalar": { "int": 1}}]],""]}}]
}}
set moduleName Decision
...
set NewPortList {[ 
	...
	{ "name": "s_axi_AXILiteS_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "AXILiteS", "role": "ARADDR" },"address":[{"name":"Decision","role":"start","value":"0","valid_bit":"0"},{"name":"Decision","role":"done","value":"0","valid_bit":"1"},{"name":"Decision","role":"idle","value":"0","valid_bit":"2"},{"name":"Decision","role":"ready","value":"0","valid_bit":"3"},{"name":"Decision","role":"auto_start","value":"0","valid_bit":"7"},{"name":"return","role":"data","value":"16"}] },
...
set RtlHierarchyInfo {[
	{"Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4"], "CDFG" : "Decision", "VariableLatency" : "1", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "ProcessNetwork" : "0", "Combinational" : "0", "ControlExist" : "1",
		"Port" : [
	...
	{"Level" : "1", "Path" : "`AUTOTB_DUT_INST.Decision_AXILiteS_s_axi_U", "Parent" : "0", "Child" : []}]}
