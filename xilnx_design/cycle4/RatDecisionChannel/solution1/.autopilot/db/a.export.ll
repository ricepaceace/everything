; ModuleID = '/home/greg/everything/xilnx_design/cycle4/RatDecisionChannel/solution1/.autopilot/db/a.o.2.bc'
...
@recentdatapoints_data = internal unnamed_addr global [5 x i16] zeroinitializer
...
@recentVBools_data = internal unnamed_addr global [60 x i1] zeroinitializer
...
@recentABools_data = internal unnamed_addr global [60 x i1] zeroinitializer
@ratDecision_str = internal unnamed_addr constant [12 x i8] c"ratDecision\00"
...
@VCaptureThresh = internal unnamed_addr global i32 16, align 4
@AstimDelay = internal unnamed_addr global i32 0, align 4
@AbeatDelay = internal unnamed_addr global i32 0, align 4
@ACaptureThresh = internal unnamed_addr global i32 52, align 4
...
._crit_edge49_ifconv:                             ; preds = %0, %codeRepl
  ...
  %tmp_i = icmp eq i32 %recentdatapoints_len_load, 5
  ...
  %recentdatapoints_data_addr = getelementptr [5 x i16]* @recentdatapoints_data, i64 0, i64 %tmp_i_4
  ...
  %i_1 = add nsw i32 %p_tmp_i, 4
  %p_i = select i1 %tmp, i32 %i_1, i32 %i
  %tmp_41_i = sext i32 %p_i to i64
  %recentdatapoints_data_addr_1 = getelementptr [5 x i16]* @recentdatapoints_data, i64 0, i64 %tmp_41_i
  ...
  %tmp_i2 = icmp eq i32 %recentVBools_len_load, 60
  %tmp_i2_5 = sext i32 %recentVBools_head_i_load to i64
  %recentVBools_data_addr = getelementptr [60 x i1]* @recentVBools_data, i64 0, i64 %tmp_i2_5
  ...
  %CircularBuffer_int_60_sum_i = select i1 %tmp_i2, i32 %tmp_29_i, i32 %recentVBools_sum_load
  store i1 %tmp_s, i1* %recentVBools_data_addr, align 1
  %CircularBuffer_sum_read_assign = add nsw i32 %CircularBuffer_int_60_sum_i, %val_assign_1
  %CircularBuffer_len_read_assign = add i32 %recentVBools_len_load, 1
  %CircularBuffer_len_read_assign_1 = select i1 %tmp_i2, i32 60, i32 %CircularBuffer_len_read_assign
  %tmp_33_i = add nsw i32 %recentVBools_head_i_load, 1
  %tmp_34_i = icmp eq i32 %tmp_33_i, 60
...
; <label>:1                                       ; preds = %._crit_edge49_ifconv
  ...
  %i_3 = add nsw i32 %i_2, 60
  %i_4 = select i1 %tmp_26, i32 %i_3, i32 %i_2
  %tmp_28_i_i = sext i32 %i_4 to i64
  %recentVBools_data_addr_1 = getelementptr [60 x i1]* @recentVBools_data, i64 0, i64 %tmp_28_i_i
  ...
  %i_6 = add nsw i32 %i_5, 60
  %i_7 = select i1 %tmp_27, i32 %i_6, i32 %i_5
  %tmp_28_i_i9 = sext i32 %i_7 to i64
  %recentVBools_data_addr_2 = getelementptr [60 x i1]* @recentVBools_data, i64 0, i64 %tmp_28_i_i9
...
._crit_edge51_ifconv:                             ; preds = %5, %4, %3, %2
  ...
  %tmp_i3 = icmp eq i32 %tmp_38_i, 5
  %tmp_i3_6 = sext i32 %p_tmp_i to i64
  %recentdatapoints_data_addr_2 = getelementptr [5 x i16]* @recentdatapoints_data, i64 0, i64 %tmp_i3_6
  ...
  %tmp_i4 = icmp eq i32 %recentABools_len_load, 60
  %tmp_i4_7 = sext i32 %recentABools_head_i_load to i64
  %recentABools_data_addr = getelementptr [60 x i1]* @recentABools_data, i64 0, i64 %tmp_i4_7
  ...
  %CircularBuffer_int_60_sum_i1 = select i1 %tmp_i4, i32 %tmp_29_i1, i32 %recentABools_sum_load
  store i1 %tmp_12, i1* %recentABools_data_addr, align 1
  %CircularBuffer_sum_read_assign_1 = add nsw i32 %CircularBuffer_int_60_sum_i1, %val_assign_2
  %CircularBuffer_len_read_assign_2 = add i32 %recentABools_len_load, 1
  %CircularBuffer_len_read_assign_3 = select i1 %tmp_i4, i32 60, i32 %CircularBuffer_len_read_assign_2
  %tmp_33_i1 = add nsw i32 %recentABools_head_i_load, 1
  %tmp_34_i1 = icmp eq i32 %tmp_33_i1, 60
...
; <label>:6                                       ; preds = %._crit_edge51_ifconv
  ...
  %i_9 = add nsw i32 %i_8, 60
  %i_10 = select i1 %tmp_28, i32 %i_9, i32 %i_8
  %tmp_28_i_i1 = sext i32 %i_10 to i64
  %recentABools_data_addr_1 = getelementptr [60 x i1]* @recentABools_data, i64 0, i64 %tmp_28_i_i1
  ...
  %i_12 = add nsw i32 %i_11, 60
  %i_13 = select i1 %tmp_29, i32 %i_12, i32 %i_11
  %tmp_28_i_i2 = sext i32 %i_13 to i64
  %recentABools_data_addr_2 = getelementptr [60 x i1]* @recentABools_data, i64 0, i64 %tmp_28_i_i2
...
; <label>:7                                       ; preds = %._crit_edge53
  ...
  %tmp_18 = icmp sgt i32 %VbeatFallDelay_new_1, 62
...
._crit_edge56_ifconv:                             ; preds = %10, %._crit_edge54, %9, %8
  ...
  %tmp_21 = icmp sgt i32 %AbeatDelay_new, 250
  ...
  %tmp_24 = icmp sgt i32 %AbeatDelay_new, 62
...
entry:
  %empty = shl i32 1, %1
  %empty_9 = and i32 %0, %empty
  %empty_10 = icmp ne i32 %empty_9, 0
  ret i1 %empty_10
}
