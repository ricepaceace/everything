; ModuleID = '/home/greg/everything/xilnx_design/cycle4/RatDecisionChannel/solution1/.autopilot/db/a.o.3.bc'
...
@recentdatapoints_data = internal unnamed_addr global [5 x i16] zeroinitializer ; [#uses=3 type=[5 x i16]*]
...
@recentVBools_data = internal unnamed_addr global [60 x i1] zeroinitializer ; [#uses=3 type=[60 x i1]*]
...
@recentABools_data = internal unnamed_addr global [60 x i1] zeroinitializer ; [#uses=3 type=[60 x i1]*]
@ratDecision_str = internal unnamed_addr constant [12 x i8] c"ratDecision\00" ; [#uses=1 type=[12 x i8]*]
...
@VCaptureThresh = internal unnamed_addr global i32 16, align 4 ; [#uses=2 type=i32*]
...
@ACaptureThresh = internal unnamed_addr global i32 52, align 4 ; [#uses=2 type=i32*]
...
; [#uses=0]
define i16 @ratDecision(i1 %reset_A_V, i1 %reset_V_V, i1 %reset_params_V, i32 %athresh, i32 %vthresh, i8 signext %a_flip, i8 signext %v_flip, i32 %a_length, i32 %v_length, i16 signext %data) {
codeRepl:
  ...
  call void (...)* @_ssdm_op_SpecTopModule([12 x i8]* @ratDecision_str) nounwind
  %data_read = call i16 @_ssdm_op_Read.s_axilite.i16(i16 %data) ; [#uses=2 type=i16]
  call void @llvm.dbg.value(metadata !{i16 %data_read}, i64 0, metadata !77), !dbg !456 ; [debug line = 6:173] [debug variable = data]
  %v_length_read = call i32 @_ssdm_op_Read.s_axilite.i32(i32 %v_length) ; [#uses=2 type=i32]
  call void @llvm.dbg.value(metadata !{i32 %v_length_read}, i64 0, metadata !457), !dbg !458 ; [debug line = 6:157] [debug variable = v_length]
  %a_length_read = call i32 @_ssdm_op_Read.s_axilite.i32(i32 %a_length) ; [#uses=2 type=i32]
  call void @llvm.dbg.value(metadata !{i32 %a_length_read}, i64 0, metadata !459), !dbg !460 ; [debug line = 6:134] [debug variable = a_length]
  %v_flip_read = call i8 @_ssdm_op_Read.s_axilite.i8(i8 %v_flip) ; [#uses=1 type=i8]
  call void @llvm.dbg.value(metadata !{i8 %v_flip_read}, i64 0, metadata !461), !dbg !462 ; [debug line = 6:113] [debug variable = v_flip]
  %a_flip_read = call i8 @_ssdm_op_Read.s_axilite.i8(i8 %a_flip) ; [#uses=1 type=i8]
  call void @llvm.dbg.value(metadata !{i8 %a_flip_read}, i64 0, metadata !463), !dbg !464 ; [debug line = 6:100] [debug variable = a_flip]
  %vthresh_read = call i32 @_ssdm_op_Read.s_axilite.i32(i32 %vthresh) ; [#uses=1 type=i32]
  call void @llvm.dbg.value(metadata !{i32 %vthresh_read}, i64 0, metadata !465), !dbg !466 ; [debug line = 6:86] [debug variable = vthresh]
  %athresh_read = call i32 @_ssdm_op_Read.s_axilite.i32(i32 %athresh) ; [#uses=1 type=i32]
  call void @llvm.dbg.value(metadata !{i32 %athresh_read}, i64 0, metadata !467), !dbg !468 ; [debug line = 6:73] [debug variable = athresh]
  ...
  call void @llvm.dbg.value(metadata !{i32 %athresh}, i64 0, metadata !467), !dbg !468 ; [debug line = 6:73] [debug variable = athresh]
  call void @llvm.dbg.value(metadata !{i32 %vthresh}, i64 0, metadata !465), !dbg !466 ; [debug line = 6:86] [debug variable = vthresh]
  call void @llvm.dbg.value(metadata !{i8 %a_flip}, i64 0, metadata !463), !dbg !464 ; [debug line = 6:100] [debug variable = a_flip]
  call void @llvm.dbg.value(metadata !{i8 %v_flip}, i64 0, metadata !461), !dbg !462 ; [debug line = 6:113] [debug variable = v_flip]
  call void @llvm.dbg.value(metadata !{i32 %a_length}, i64 0, metadata !459), !dbg !460 ; [debug line = 6:134] [debug variable = a_length]
  call void @llvm.dbg.value(metadata !{i32 %v_length}, i64 0, metadata !457), !dbg !458 ; [debug line = 6:157] [debug variable = v_length]
  call void @llvm.dbg.value(metadata !{i16 %data}, i64 0, metadata !77), !dbg !456 ; [debug line = 6:173] [debug variable = data]
...
._crit_edge49_ifconv:                             ; preds = %0, %codeRepl
  ...
  %tmp_i = icmp eq i32 %recentdatapoints_len_load, 5, !dbg !524 ; [#uses=2 type=i1] [debug line = 14:3@61:2]
  ...
  %tmp_i_4 = sext i32 %recentdatapoints_head_i_load to i64, !dbg !526 ; [#uses=1 type=i64] [debug line = 15:4@61:2]
  %recentdatapoints_data_addr = getelementptr [5 x i16]* @recentdatapoints_data, i64 0, i64 %tmp_i_4, !dbg !526 ; [#uses=2 type=i16*] [debug line = 15:4@61:2]
  ...
  %tmp_38_i = select i1 %tmp_i, i32 5, i32 %recentdatapoints_len_load_op, !dbg !530 ; [#uses=3 type=i32] [debug line = 20:3@61:2]
  ...
  %tmp_40_i = icmp eq i32 %tmp_39_i, 5, !dbg !532 ; [#uses=1 type=i1] [debug line = 22:3@61:2]
  ...
  %i_1 = add nsw i32 %p_tmp_i, 4, !dbg !543       ; [#uses=1 type=i32] [debug line = 37:4@71:19]
  ...
  %recentdatapoints_data_addr_1 = getelementptr [5 x i16]* @recentdatapoints_data, i64 0, i64 %tmp_41_i, !dbg !544 ; [#uses=1 type=i16*] [debug line = 38:3@71:19]
  ...
  call void @llvm.dbg.value(metadata !{i32 %recentVBools_sum_load}, i64 0, metadata !549), !dbg !580 ; [debug line = 13:7@77:2] [debug variable = CircularBuffer<int, 60>.sum]
  call void @llvm.dbg.value(metadata !{i32 %recentVBools_head_i_load}, i64 0, metadata !581), !dbg !580 ; [debug line = 13:7@77:2] [debug variable = CircularBuffer<int, 60>.head_i]
  call void @llvm.dbg.value(metadata !{i32 %recentVBools_len_load}, i64 0, metadata !585), !dbg !580 ; [debug line = 13:7@77:2] [debug variable = CircularBuffer<int, 60>.len]
  call void @llvm.dbg.value(metadata !{i32 %val_assign_1}, i64 0, metadata !589), !dbg !590 ; [debug line = 13:14@77:2] [debug variable = val]
  %tmp_i2 = icmp eq i32 %recentVBools_len_load, 60, !dbg !591 ; [#uses=2 type=i1] [debug line = 14:3@77:2]
  %tmp_i2_5 = sext i32 %recentVBools_head_i_load to i64, !dbg !593 ; [#uses=1 type=i64] [debug line = 15:4@77:2]
  %recentVBools_data_addr = getelementptr [60 x i1]* @recentVBools_data, i64 0, i64 %tmp_i2_5, !dbg !593 ; [#uses=2 type=i1*] [debug line = 15:4@77:2]
  ...
  %CircularBuffer_int_60_sum_i = select i1 %tmp_i2, i32 %tmp_29_i, i32 %recentVBools_sum_load ; [#uses=1 type=i32]
  store i1 %tmp_s, i1* %recentVBools_data_addr, align 1, !dbg !595 ; [debug line = 18:3@77:2]
  %CircularBuffer_sum_read_assign = add nsw i32 %CircularBuffer_int_60_sum_i, %val_assign_1, !dbg !596 ; [#uses=2 type=i32] [debug line = 19:3@77:2]
  %CircularBuffer_len_read_assign = add i32 %recentVBools_len_load, 1, !dbg !597 ; [#uses=1 type=i32] [debug line = 20:3@77:2]
  %CircularBuffer_len_read_assign_1 = select i1 %tmp_i2, i32 60, i32 %CircularBuffer_len_read_assign, !dbg !597 ; [#uses=6 type=i32] [debug line = 20:3@77:2]
  %tmp_33_i = add nsw i32 %recentVBools_head_i_load, 1, !dbg !598 ; [#uses=2 type=i32] [debug line = 21:3@77:2]
  %tmp_34_i = icmp eq i32 %tmp_33_i, 60, !dbg !599 ; [#uses=1 type=i1] [debug line = 22:3@77:2]
...
; <label>:1                                       ; preds = %._crit_edge49_ifconv
  call void @llvm.dbg.value(metadata !{i32 %CircularBuffer_sum_read_assign}, i64 0, metadata !600), !dbg !605 ; [debug line = 25:4@81:3] [debug variable = CircularBuffer<int, 60>.sum]
  call void @llvm.dbg.value(metadata !{i32 %CircularBuffer_head_i_read_ass}, i64 0, metadata !606), !dbg !605 ; [debug line = 25:4@81:3] [debug variable = CircularBuffer<int, 60>.head_i]
  call void @llvm.dbg.value(metadata !{i32 %CircularBuffer_len_read_assign_1}, i64 0, metadata !607), !dbg !605 ; [debug line = 25:4@81:3] [debug variable = CircularBuffer<int, 60>.len]
  call void @llvm.dbg.value(metadata !{i32 %CircularBuffer_head_i_read_ass}, i64 0, metadata !608), !dbg !613 ; [debug line = 41:4@26:16@81:3] [debug variable = CircularBuffer<int, 60>.head_i]
  call void @llvm.dbg.value(metadata !{i32 %CircularBuffer_len_read_assign_1}, i64 0, metadata !614), !dbg !613 ; [debug line = 41:4@26:16@81:3] [debug variable = CircularBuffer<int, 60>.len]
  ...
  %i_3 = add nsw i32 %i_2, 60, !dbg !619          ; [#uses=1 type=i32] [debug line = 46:4@26:16@81:3]
  ...
  %recentVBools_data_addr_1 = getelementptr [60 x i1]* @recentVBools_data, i64 0, i64 %tmp_28_i_i, !dbg !620 ; [#uses=1 type=i1*] [debug line = 47:3@26:16@81:3]
  ...
  call void @llvm.dbg.value(metadata !{i32 %CircularBuffer_sum_write_assig}, i64 0, metadata !624), !dbg !605 ; [debug line = 25:4@81:3] [debug variable = CircularBuffer<int, 60>.sum]
  call void @llvm.dbg.value(metadata !{i32 %CircularBuffer_len_write_assig}, i64 0, metadata !625), !dbg !605 ; [debug line = 25:4@81:3] [debug variable = CircularBuffer<int, 60>.len]
  call void @llvm.dbg.value(metadata !{i32 %CircularBuffer_sum_write_assig}, i64 0, metadata !626), !dbg !628 ; [debug line = 25:4@82:3] [debug variable = CircularBuffer<int, 60>.sum]
  call void @llvm.dbg.value(metadata !{i32 %CircularBuffer_head_i_read_ass}, i64 0, metadata !629), !dbg !628 ; [debug line = 25:4@82:3] [debug variable = CircularBuffer<int, 60>.head_i]
  call void @llvm.dbg.value(metadata !{i32 %CircularBuffer_len_write_assig}, i64 0, metadata !630), !dbg !628 ; [debug line = 25:4@82:3] [debug variable = CircularBuffer<int, 60>.len]
  call void @llvm.dbg.value(metadata !{i32 %CircularBuffer_head_i_read_ass}, i64 0, metadata !631), !dbg !633 ; [debug line = 41:4@26:16@82:3] [debug variable = CircularBuffer<int, 60>.head_i]
  call void @llvm.dbg.value(metadata !{i32 %CircularBuffer_len_write_assig}, i64 0, metadata !634), !dbg !633 ; [debug line = 41:4@26:16@82:3] [debug variable = CircularBuffer<int, 60>.len]
  ...
  %i_6 = add nsw i32 %i_5, 60, !dbg !638          ; [#uses=1 type=i32] [debug line = 46:4@26:16@82:3]
  ...
  %recentVBools_data_addr_2 = getelementptr [60 x i1]* @recentVBools_data, i64 0, i64 %tmp_28_i_i9, !dbg !639 ; [#uses=1 type=i1*] [debug line = 47:3@26:16@82:3]
  ...
  call void @llvm.dbg.value(metadata !{i32 %CircularBuffer_sum_write_assig_1}, i64 0, metadata !643), !dbg !628 ; [debug line = 25:4@82:3] [debug variable = CircularBuffer<int, 60>.sum]
  call void @llvm.dbg.value(metadata !{i32 %CircularBuffer_len_write_assig_1}, i64 0, metadata !644), !dbg !628 ; [debug line = 25:4@82:3] [debug variable = CircularBuffer<int, 60>.len]
...
._crit_edge51_ifconv:                             ; preds = %5, %4, %3, %2
  ...
  %tmp_i3 = icmp eq i32 %tmp_38_i, 5, !dbg !665   ; [#uses=1 type=i1] [debug line = 53:3@103:19]
  %tmp_i3_6 = sext i32 %p_tmp_i to i64, !dbg !669 ; [#uses=1 type=i64] [debug line = 54:4@103:19]
  %recentdatapoints_data_addr_2 = getelementptr [5 x i16]* @recentdatapoints_data, i64 0, i64 %tmp_i3_6, !dbg !669 ; [#uses=1 type=i16*] [debug line = 54:4@103:19]
  ...
  call void @llvm.dbg.value(metadata !{i32 %recentABools_sum_load}, i64 0, metadata !674), !dbg !675 ; [debug line = 13:7@108:2] [debug variable = CircularBuffer<int, 60>.sum]
  call void @llvm.dbg.value(metadata !{i32 %recentABools_head_i_load}, i64 0, metadata !676), !dbg !675 ; [debug line = 13:7@108:2] [debug variable = CircularBuffer<int, 60>.head_i]
  call void @llvm.dbg.value(metadata !{i32 %recentABools_len_load}, i64 0, metadata !677), !dbg !675 ; [debug line = 13:7@108:2] [debug variable = CircularBuffer<int, 60>.len]
  call void @llvm.dbg.value(metadata !{i32 %val_assign_2}, i64 0, metadata !678), !dbg !679 ; [debug line = 13:14@108:2] [debug variable = val]
  %tmp_i4 = icmp eq i32 %recentABools_len_load, 60, !dbg !680 ; [#uses=2 type=i1] [debug line = 14:3@108:2]
  %tmp_i4_7 = sext i32 %recentABools_head_i_load to i64, !dbg !681 ; [#uses=1 type=i64] [debug line = 15:4@108:2]
  %recentABools_data_addr = getelementptr [60 x i1]* @recentABools_data, i64 0, i64 %tmp_i4_7, !dbg !681 ; [#uses=2 type=i1*] [debug line = 15:4@108:2]
  ...
  %CircularBuffer_int_60_sum_i1 = select i1 %tmp_i4, i32 %tmp_29_i1, i32 %recentABools_sum_load ; [#uses=1 type=i32]
  store i1 %tmp_12, i1* %recentABools_data_addr, align 1, !dbg !682 ; [debug line = 18:3@108:2]
  %CircularBuffer_sum_read_assign_1 = add nsw i32 %CircularBuffer_int_60_sum_i1, %val_assign_2, !dbg !683 ; [#uses=2 type=i32] [debug line = 19:3@108:2]
  %CircularBuffer_len_read_assign_2 = add i32 %recentABools_len_load, 1, !dbg !684 ; [#uses=1 type=i32] [debug line = 20:3@108:2]
  %CircularBuffer_len_read_assign_3 = select i1 %tmp_i4, i32 60, i32 %CircularBuffer_len_read_assign_2, !dbg !684 ; [#uses=6 type=i32] [debug line = 20:3@108:2]
  %tmp_33_i1 = add nsw i32 %recentABools_head_i_load, 1, !dbg !685 ; [#uses=2 type=i32] [debug line = 21:3@108:2]
  %tmp_34_i1 = icmp eq i32 %tmp_33_i1, 60, !dbg !686 ; [#uses=1 type=i1] [debug line = 22:3@108:2]
...
; <label>:6                                       ; preds = %._crit_edge51_ifconv
  call void @llvm.dbg.value(metadata !{i32 %CircularBuffer_sum_read_assign_1}, i64 0, metadata !687), !dbg !690 ; [debug line = 25:4@112:3] [debug variable = CircularBuffer<int, 60>.sum]
  call void @llvm.dbg.value(metadata !{i32 %CircularBuffer_head_i_read_ass_1}, i64 0, metadata !691), !dbg !690 ; [debug line = 25:4@112:3] [debug variable = CircularBuffer<int, 60>.head_i]
  call void @llvm.dbg.value(metadata !{i32 %CircularBuffer_len_read_assign_3}, i64 0, metadata !692), !dbg !690 ; [debug line = 25:4@112:3] [debug variable = CircularBuffer<int, 60>.len]
  call void @llvm.dbg.value(metadata !{i32 %CircularBuffer_head_i_read_ass_1}, i64 0, metadata !693), !dbg !695 ; [debug line = 41:4@26:16@112:3] [debug variable = CircularBuffer<int, 60>.head_i]
  call void @llvm.dbg.value(metadata !{i32 %CircularBuffer_len_read_assign_3}, i64 0, metadata !696), !dbg !695 ; [debug line = 41:4@26:16@112:3] [debug variable = CircularBuffer<int, 60>.len]
  ...
  %i_9 = add nsw i32 %i_8, 60, !dbg !700          ; [#uses=1 type=i32] [debug line = 46:4@26:16@112:3]
  ...
  %recentABools_data_addr_1 = getelementptr [60 x i1]* @recentABools_data, i64 0, i64 %tmp_28_i_i1, !dbg !701 ; [#uses=1 type=i1*] [debug line = 47:3@26:16@112:3]
  ...
  call void @llvm.dbg.value(metadata !{i32 %CircularBuffer_sum_write_assig_2}, i64 0, metadata !705), !dbg !690 ; [debug line = 25:4@112:3] [debug variable = CircularBuffer<int, 60>.sum]
  call void @llvm.dbg.value(metadata !{i32 %CircularBuffer_len_write_assig_2}, i64 0, metadata !706), !dbg !690 ; [debug line = 25:4@112:3] [debug variable = CircularBuffer<int, 60>.len]
  call void @llvm.dbg.value(metadata !{i32 %CircularBuffer_sum_write_assig_2}, i64 0, metadata !707), !dbg !709 ; [debug line = 25:4@113:3] [debug variable = CircularBuffer<int, 60>.sum]
  call void @llvm.dbg.value(metadata !{i32 %CircularBuffer_head_i_read_ass_1}, i64 0, metadata !710), !dbg !709 ; [debug line = 25:4@113:3] [debug variable = CircularBuffer<int, 60>.head_i]
  call void @llvm.dbg.value(metadata !{i32 %CircularBuffer_len_write_assig_2}, i64 0, metadata !711), !dbg !709 ; [debug line = 25:4@113:3] [debug variable = CircularBuffer<int, 60>.len]
  call void @llvm.dbg.value(metadata !{i32 %CircularBuffer_head_i_read_ass_1}, i64 0, metadata !712), !dbg !714 ; [debug line = 41:4@26:16@113:3] [debug variable = CircularBuffer<int, 60>.head_i]
  call void @llvm.dbg.value(metadata !{i32 %CircularBuffer_len_write_assig_2}, i64 0, metadata !715), !dbg !714 ; [debug line = 41:4@26:16@113:3] [debug variable = CircularBuffer<int, 60>.len]
  ...
  %i_12 = add nsw i32 %i_11, 60, !dbg !719        ; [#uses=1 type=i32] [debug line = 46:4@26:16@113:3]
  ...
  %recentABools_data_addr_2 = getelementptr [60 x i1]* @recentABools_data, i64 0, i64 %tmp_28_i_i2, !dbg !720 ; [#uses=1 type=i1*] [debug line = 47:3@26:16@113:3]
  ...
  call void @llvm.dbg.value(metadata !{i32 %CircularBuffer_sum_write_assig_3}, i64 0, metadata !724), !dbg !709 ; [debug line = 25:4@113:3] [debug variable = CircularBuffer<int, 60>.sum]
  call void @llvm.dbg.value(metadata !{i32 %CircularBuffer_len_write_assig_3}, i64 0, metadata !725), !dbg !709 ; [debug line = 25:4@113:3] [debug variable = CircularBuffer<int, 60>.len]
...
; <label>:7                                       ; preds = %._crit_edge53
  ...
  %tmp_18 = icmp sgt i32 %VbeatFallDelay_new_1, 62, !dbg !728 ; [#uses=1 type=i1] [debug line = 118:2]
...
._crit_edge56_ifconv:                             ; preds = %10, %._crit_edge54, %9, %8
  ...
  %tmp_21 = icmp sgt i32 %AbeatDelay_new, 250, !dbg !744 ; [#uses=1 type=i1] [debug line = 145:2]
  ...
  %tmp_24 = icmp sgt i32 %AbeatDelay_new, 62, !dbg !748 ; [#uses=1 type=i1] [debug line = 151:2]
...
entry:
  ...
  %empty_9 = and i32 %0, %empty                   ; [#uses=1 type=i32]
  %empty_10 = icmp ne i32 %empty_9, 0             ; [#uses=1 type=i1]
  ret i1 %empty_10
}
...
!78 = metadata !{i32 786478, i32 0, metadata !79, metadata !"ratDecision", metadata !"ratDecision", metadata !"_Z11ratDecision7ap_uintILi1EES0_S0_iiccjjs", metadata !79, i32 6, metadata !80, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !101, i32 7} ; [ DW_TAG_subprogram ]
!79 = metadata !{i32 786473, metadata !"../cycle3/src/hls/ratChannel.cpp", metadata !"/home/greg/everything/xilnx_design/cycle4", null} ; [ DW_TAG_file_type ]
...
!85 = metadata !{i32 786473, metadata !"/opt/Xilinx/Vivado_HLS/2016.2/common/technology/autopilot/ap_int.h", metadata !"/home/greg/everything/xilnx_design/cycle4", null} ; [ DW_TAG_file_type ]
...
!89 = metadata !{i32 786473, metadata !"/opt/Xilinx/Vivado_HLS/2016.2/common/technology/autopilot/ap_int_syn.h", metadata !"/home/greg/everything/xilnx_design/cycle4", null} ; [ DW_TAG_file_type ]
...
!93 = metadata !{i32 786473, metadata !"/opt/Xilinx/Vivado_HLS/2016.2/common/technology/autopilot/etc/autopilot_dt.def", metadata !"/home/greg/everything/xilnx_design/cycle4", null} ; [ DW_TAG_file_type ]
...
!456 = metadata !{i32 6, i32 173, metadata !78, null}
...
!458 = metadata !{i32 6, i32 157, metadata !78, null}
...
!460 = metadata !{i32 6, i32 134, metadata !78, null}
...
!462 = metadata !{i32 6, i32 113, metadata !78, null}
...
!464 = metadata !{i32 6, i32 100, metadata !78, null}
...
!466 = metadata !{i32 6, i32 86, metadata !78, null}
...
!468 = metadata !{i32 6, i32 73, metadata !78, null}
...
!495 = metadata !{i32 786478, i32 0, null, metadata !"push", metadata !"push", metadata !"_ZN14CircularBufferIiLi5EE4pushEi", metadata !496, i32 13, metadata !497, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !512, metadata !101, i32 13} ; [ DW_TAG_subprogram ]
!496 = metadata !{i32 786473, metadata !"../cycle3/src/hls/circularBuffer.h", metadata !"/home/greg/everything/xilnx_design/cycle4", null} ; [ DW_TAG_file_type ]
...
!500 = metadata !{i32 786434, null, metadata !"CircularBuffer<int, 5>", metadata !496, i32 4, i64 256, i64 32, i32 0, i32 0, null, metadata !501, i32 0, null, metadata !519} ; [ DW_TAG_class_type ]
...
!503 = metadata !{i32 786445, metadata !500, metadata !"data", metadata !496, i32 6, i64 160, i64 32, i64 32, i32 0, metadata !504} ; [ DW_TAG_member ]
!504 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 160, i64 32, i32 0, i32 0, metadata !110, metadata !505, i32 0, i32 0} ; [ DW_TAG_array_type ]
!505 = metadata !{metadata !506}
!506 = metadata !{i32 786465, i64 0, i64 4}       ; [ DW_TAG_subrange_type ]
!507 = metadata !{i32 786445, metadata !500, metadata !"head_i", metadata !496, i32 7, i64 32, i64 32, i64 192, i32 0, metadata !110} ; [ DW_TAG_member ]
!508 = metadata !{i32 786445, metadata !500, metadata !"len", metadata !496, i32 8, i64 32, i64 32, i64 224, i32 0, metadata !110} ; [ DW_TAG_member ]
...
!512 = metadata !{i32 786478, i32 0, metadata !500, metadata !"push", metadata !"push", metadata !"_ZN14CircularBufferIiLi5EE4pushEi", metadata !496, i32 13, metadata !497, i1 false, i1 false, i32 0, i32 0, null, i32 256, i1 false, null, null, i32 0, metadata !101, i32 13} ; [ DW_TAG_subprogram ]
!513 = metadata !{i32 786478, i32 0, metadata !500, metadata !"pop", metadata !"pop", metadata !"_ZN14CircularBufferIiLi5EE3popEv", metadata !496, i32 25, metadata !514, i1 false, i1 false, i32 0, i32 0, null, i32 256, i1 false, null, null, i32 0, metadata !101, i32 25} ; [ DW_TAG_subprogram ]
!514 = metadata !{i32 786453, i32 0, metadata !"", i32 0, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !515, i32 0, i32 0} ; [ DW_TAG_subroutine_type ]
!515 = metadata !{metadata !110, metadata !499}
!516 = metadata !{i32 786478, i32 0, metadata !500, metadata !"head", metadata !"head", metadata !"_ZN14CircularBufferIiLi5EE4headEv", metadata !496, i32 32, metadata !514, i1 false, i1 false, i32 0, i32 0, null, i32 256, i1 false, null, null, i32 0, metadata !101, i32 32} ; [ DW_TAG_subprogram ]
!517 = metadata !{i32 786478, i32 0, metadata !500, metadata !"tail", metadata !"tail", metadata !"_ZN14CircularBufferIiLi5EE4tailEv", metadata !496, i32 41, metadata !514, i1 false, i1 false, i32 0, i32 0, null, i32 256, i1 false, null, null, i32 0, metadata !101, i32 41} ; [ DW_TAG_subprogram ]
!518 = metadata !{i32 786478, i32 0, metadata !500, metadata !"ftail", metadata !"ftail", metadata !"_ZN14CircularBufferIiLi5EE5ftailEv", metadata !496, i32 52, metadata !514, i1 false, i1 false, i32 0, i32 0, null, i32 256, i1 false, null, null, i32 0, metadata !101, i32 52} ; [ DW_TAG_subprogram ]
...
!521 = metadata !{i32 786480, null, metadata !"maxsize", metadata !110, i64 5, null, i32 0, i32 0} ; [ DW_TAG_template_value_parameter ]
...
!538 = metadata !{i32 786478, i32 0, null, metadata !"head", metadata !"head", metadata !"_ZN14CircularBufferIiLi5EE4headEv", metadata !496, i32 32, metadata !514, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !516, metadata !101, i32 32} ; [ DW_TAG_subprogram ]
...
!549 = metadata !{i32 790533, metadata !550, metadata !"CircularBuffer<int, 60>.sum", null, i32 13, metadata !577, i32 0, metadata !548} ; [ DW_TAG_arg_variable_field_ro ]
...
!551 = metadata !{i32 786478, i32 0, null, metadata !"push", metadata !"push", metadata !"_ZN14CircularBufferIiLi60EE4pushEi", metadata !496, i32 13, metadata !552, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !567, metadata !101, i32 13} ; [ DW_TAG_subprogram ]
...
!555 = metadata !{i32 786434, null, metadata !"CircularBuffer<int, 60>", metadata !496, i32 4, i64 2016, i64 32, i32 0, i32 0, null, metadata !556, i32 0, null, metadata !574} ; [ DW_TAG_class_type ]
...
!558 = metadata !{i32 786445, metadata !555, metadata !"data", metadata !496, i32 6, i64 1920, i64 32, i64 32, i32 0, metadata !559} ; [ DW_TAG_member ]
!559 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 1920, i64 32, i32 0, i32 0, metadata !110, metadata !560, i32 0, i32 0} ; [ DW_TAG_array_type ]
!560 = metadata !{metadata !561}
!561 = metadata !{i32 786465, i64 0, i64 59}      ; [ DW_TAG_subrange_type ]
!562 = metadata !{i32 786445, metadata !555, metadata !"head_i", metadata !496, i32 7, i64 32, i64 32, i64 1952, i32 0, metadata !110} ; [ DW_TAG_member ]
!563 = metadata !{i32 786445, metadata !555, metadata !"len", metadata !496, i32 8, i64 32, i64 32, i64 1984, i32 0, metadata !110} ; [ DW_TAG_member ]
...
!567 = metadata !{i32 786478, i32 0, metadata !555, metadata !"push", metadata !"push", metadata !"_ZN14CircularBufferIiLi60EE4pushEi", metadata !496, i32 13, metadata !552, i1 false, i1 false, i32 0, i32 0, null, i32 256, i1 false, null, null, i32 0, metadata !101, i32 13} ; [ DW_TAG_subprogram ]
!568 = metadata !{i32 786478, i32 0, metadata !555, metadata !"pop", metadata !"pop", metadata !"_ZN14CircularBufferIiLi60EE3popEv", metadata !496, i32 25, metadata !569, i1 false, i1 false, i32 0, i32 0, null, i32 256, i1 false, null, null, i32 0, metadata !101, i32 25} ; [ DW_TAG_subprogram ]
!569 = metadata !{i32 786453, i32 0, metadata !"", i32 0, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !570, i32 0, i32 0} ; [ DW_TAG_subroutine_type ]
!570 = metadata !{metadata !110, metadata !554}
!571 = metadata !{i32 786478, i32 0, metadata !555, metadata !"head", metadata !"head", metadata !"_ZN14CircularBufferIiLi60EE4headEv", metadata !496, i32 32, metadata !569, i1 false, i1 false, i32 0, i32 0, null, i32 256, i1 false, null, null, i32 0, metadata !101, i32 32} ; [ DW_TAG_subprogram ]
!572 = metadata !{i32 786478, i32 0, metadata !555, metadata !"tail", metadata !"tail", metadata !"_ZN14CircularBufferIiLi60EE4tailEv", metadata !496, i32 41, metadata !569, i1 false, i1 false, i32 0, i32 0, null, i32 256, i1 false, null, null, i32 0, metadata !101, i32 41} ; [ DW_TAG_subprogram ]
!573 = metadata !{i32 786478, i32 0, metadata !555, metadata !"ftail", metadata !"ftail", metadata !"_ZN14CircularBufferIiLi60EE5ftailEv", metadata !496, i32 52, metadata !569, i1 false, i1 false, i32 0, i32 0, null, i32 256, i1 false, null, null, i32 0, metadata !101, i32 52} ; [ DW_TAG_subprogram ]
!574 = metadata !{metadata !520, metadata !575}
!575 = metadata !{i32 786480, null, metadata !"maxsize", metadata !110, i64 60, null, i32 0, i32 0} ; [ DW_TAG_template_value_parameter ]
...
!578 = metadata !{i32 786438, null, metadata !"CircularBuffer<int, 60>", metadata !496, i32 4, i64 32, i64 32, i32 0, i32 0, null, metadata !579, i32 0, null, metadata !574} ; [ DW_TAG_class_field_type ]
!579 = metadata !{metadata !557}
!580 = metadata !{i32 13, i32 7, metadata !551, metadata !548}
!581 = metadata !{i32 790533, metadata !550, metadata !"CircularBuffer<int, 60>.head_i", null, i32 13, metadata !582, i32 0, metadata !548} ; [ DW_TAG_arg_variable_field_ro ]
!582 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !583} ; [ DW_TAG_pointer_type ]
!583 = metadata !{i32 786438, null, metadata !"CircularBuffer<int, 60>", metadata !496, i32 4, i64 32, i64 32, i32 0, i32 0, null, metadata !584, i32 0, null, metadata !574} ; [ DW_TAG_class_field_type ]
!584 = metadata !{metadata !562}
!585 = metadata !{i32 790533, metadata !550, metadata !"CircularBuffer<int, 60>.len", null, i32 13, metadata !586, i32 0, metadata !548} ; [ DW_TAG_arg_variable_field_ro ]
!586 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !587} ; [ DW_TAG_pointer_type ]
!587 = metadata !{i32 786438, null, metadata !"CircularBuffer<int, 60>", metadata !496, i32 4, i64 32, i64 32, i32 0, i32 0, null, metadata !588, i32 0, null, metadata !574} ; [ DW_TAG_class_field_type ]
...
!600 = metadata !{i32 790533, metadata !601, metadata !"CircularBuffer<int, 60>.sum", null, i32 25, metadata !577, i32 0, metadata !603} ; [ DW_TAG_arg_variable_field_ro ]
...
!602 = metadata !{i32 786478, i32 0, null, metadata !"pop", metadata !"pop", metadata !"_ZN14CircularBufferIiLi60EE3popEv", metadata !496, i32 25, metadata !569, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !568, metadata !101, i32 25} ; [ DW_TAG_subprogram ]
...
!606 = metadata !{i32 790533, metadata !601, metadata !"CircularBuffer<int, 60>.head_i", null, i32 25, metadata !582, i32 0, metadata !603} ; [ DW_TAG_arg_variable_field_ro ]
!607 = metadata !{i32 790533, metadata !601, metadata !"CircularBuffer<int, 60>.len", null, i32 25, metadata !586, i32 0, metadata !603} ; [ DW_TAG_arg_variable_field_ro ]
!608 = metadata !{i32 790533, metadata !609, metadata !"CircularBuffer<int, 60>.head_i", null, i32 41, metadata !582, i32 0, metadata !611} ; [ DW_TAG_arg_variable_field_ro ]
...
!610 = metadata !{i32 786478, i32 0, null, metadata !"tail", metadata !"tail", metadata !"_ZN14CircularBufferIiLi60EE4tailEv", metadata !496, i32 41, metadata !569, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !572, metadata !101, i32 41} ; [ DW_TAG_subprogram ]
...
!614 = metadata !{i32 790533, metadata !609, metadata !"CircularBuffer<int, 60>.len", null, i32 41, metadata !586, i32 0, metadata !611} ; [ DW_TAG_arg_variable_field_ro ]
...
!624 = metadata !{i32 790535, metadata !601, metadata !"CircularBuffer<int, 60>.sum", null, i32 25, metadata !577, i32 0, metadata !603} ; [ DW_TAG_arg_variable_field_wo ]
!625 = metadata !{i32 790535, metadata !601, metadata !"CircularBuffer<int, 60>.len", null, i32 25, metadata !586, i32 0, metadata !603} ; [ DW_TAG_arg_variable_field_wo ]
!626 = metadata !{i32 790533, metadata !601, metadata !"CircularBuffer<int, 60>.sum", null, i32 25, metadata !577, i32 0, metadata !627} ; [ DW_TAG_arg_variable_field_ro ]
!627 = metadata !{i32 82, i32 3, metadata !604, null}
!628 = metadata !{i32 25, i32 4, metadata !602, metadata !627}
!629 = metadata !{i32 790533, metadata !601, metadata !"CircularBuffer<int, 60>.head_i", null, i32 25, metadata !582, i32 0, metadata !627} ; [ DW_TAG_arg_variable_field_ro ]
!630 = metadata !{i32 790533, metadata !601, metadata !"CircularBuffer<int, 60>.len", null, i32 25, metadata !586, i32 0, metadata !627} ; [ DW_TAG_arg_variable_field_ro ]
!631 = metadata !{i32 790533, metadata !609, metadata !"CircularBuffer<int, 60>.head_i", null, i32 41, metadata !582, i32 0, metadata !632} ; [ DW_TAG_arg_variable_field_ro ]
!632 = metadata !{i32 26, i32 16, metadata !612, metadata !627}
!633 = metadata !{i32 41, i32 4, metadata !610, metadata !632}
!634 = metadata !{i32 790533, metadata !609, metadata !"CircularBuffer<int, 60>.len", null, i32 41, metadata !586, i32 0, metadata !632} ; [ DW_TAG_arg_variable_field_ro ]
...
!643 = metadata !{i32 790535, metadata !601, metadata !"CircularBuffer<int, 60>.sum", null, i32 25, metadata !577, i32 0, metadata !627} ; [ DW_TAG_arg_variable_field_wo ]
!644 = metadata !{i32 790535, metadata !601, metadata !"CircularBuffer<int, 60>.len", null, i32 25, metadata !586, i32 0, metadata !627} ; [ DW_TAG_arg_variable_field_wo ]
...
!667 = metadata !{i32 786478, i32 0, null, metadata !"ftail", metadata !"ftail", metadata !"_ZN14CircularBufferIiLi5EE5ftailEv", metadata !496, i32 52, metadata !514, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !518, metadata !101, i32 52} ; [ DW_TAG_subprogram ]
...
!674 = metadata !{i32 790533, metadata !550, metadata !"CircularBuffer<int, 60>.sum", null, i32 13, metadata !577, i32 0, metadata !673} ; [ DW_TAG_arg_variable_field_ro ]
!675 = metadata !{i32 13, i32 7, metadata !551, metadata !673}
!676 = metadata !{i32 790533, metadata !550, metadata !"CircularBuffer<int, 60>.head_i", null, i32 13, metadata !582, i32 0, metadata !673} ; [ DW_TAG_arg_variable_field_ro ]
!677 = metadata !{i32 790533, metadata !550, metadata !"CircularBuffer<int, 60>.len", null, i32 13, metadata !586, i32 0, metadata !673} ; [ DW_TAG_arg_variable_field_ro ]
...
!687 = metadata !{i32 790533, metadata !601, metadata !"CircularBuffer<int, 60>.sum", null, i32 25, metadata !577, i32 0, metadata !688} ; [ DW_TAG_arg_variable_field_ro ]
...
!691 = metadata !{i32 790533, metadata !601, metadata !"CircularBuffer<int, 60>.head_i", null, i32 25, metadata !582, i32 0, metadata !688} ; [ DW_TAG_arg_variable_field_ro ]
!692 = metadata !{i32 790533, metadata !601, metadata !"CircularBuffer<int, 60>.len", null, i32 25, metadata !586, i32 0, metadata !688} ; [ DW_TAG_arg_variable_field_ro ]
!693 = metadata !{i32 790533, metadata !609, metadata !"CircularBuffer<int, 60>.head_i", null, i32 41, metadata !582, i32 0, metadata !694} ; [ DW_TAG_arg_variable_field_ro ]
!694 = metadata !{i32 26, i32 16, metadata !612, metadata !688}
!695 = metadata !{i32 41, i32 4, metadata !610, metadata !694}
!696 = metadata !{i32 790533, metadata !609, metadata !"CircularBuffer<int, 60>.len", null, i32 41, metadata !586, i32 0, metadata !694} ; [ DW_TAG_arg_variable_field_ro ]
...
!705 = metadata !{i32 790535, metadata !601, metadata !"CircularBuffer<int, 60>.sum", null, i32 25, metadata !577, i32 0, metadata !688} ; [ DW_TAG_arg_variable_field_wo ]
!706 = metadata !{i32 790535, metadata !601, metadata !"CircularBuffer<int, 60>.len", null, i32 25, metadata !586, i32 0, metadata !688} ; [ DW_TAG_arg_variable_field_wo ]
!707 = metadata !{i32 790533, metadata !601, metadata !"CircularBuffer<int, 60>.sum", null, i32 25, metadata !577, i32 0, metadata !708} ; [ DW_TAG_arg_variable_field_ro ]
!708 = metadata !{i32 113, i32 3, metadata !689, null}
!709 = metadata !{i32 25, i32 4, metadata !602, metadata !708}
!710 = metadata !{i32 790533, metadata !601, metadata !"CircularBuffer<int, 60>.head_i", null, i32 25, metadata !582, i32 0, metadata !708} ; [ DW_TAG_arg_variable_field_ro ]
!711 = metadata !{i32 790533, metadata !601, metadata !"CircularBuffer<int, 60>.len", null, i32 25, metadata !586, i32 0, metadata !708} ; [ DW_TAG_arg_variable_field_ro ]
!712 = metadata !{i32 790533, metadata !609, metadata !"CircularBuffer<int, 60>.head_i", null, i32 41, metadata !582, i32 0, metadata !713} ; [ DW_TAG_arg_variable_field_ro ]
!713 = metadata !{i32 26, i32 16, metadata !612, metadata !708}
!714 = metadata !{i32 41, i32 4, metadata !610, metadata !713}
!715 = metadata !{i32 790533, metadata !609, metadata !"CircularBuffer<int, 60>.len", null, i32 41, metadata !586, i32 0, metadata !713} ; [ DW_TAG_arg_variable_field_ro ]
...
!724 = metadata !{i32 790535, metadata !601, metadata !"CircularBuffer<int, 60>.sum", null, i32 25, metadata !577, i32 0, metadata !708} ; [ DW_TAG_arg_variable_field_wo ]
!725 = metadata !{i32 790535, metadata !601, metadata !"CircularBuffer<int, 60>.len", null, i32 25, metadata !586, i32 0, metadata !708} ; [ DW_TAG_arg_variable_field_wo ]
