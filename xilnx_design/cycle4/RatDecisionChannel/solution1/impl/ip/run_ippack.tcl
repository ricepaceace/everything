...
set Vendor      "PaceAce"
set Library     "hls"
set IPName      "ratDecision"
set Version     "1.0"
set DisplayName "Ratdecision"
set Revision    "1704081437"
set Description "Decision Channel for Langendorff"
set Device      "zynq"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{ 0x00 CTRL       RW   0x0 "Control signals"  {  { 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." }  { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." }  { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." }  { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." }  { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." }  { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." }  { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }  } }  { 0x04 GIER       RW   0x0 "Global Interrupt Enable Register"   {  { 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" }  { 1 30 RESERVED R 0 "Reserved.  0s on read." }  } }  { 0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register"   {  { 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." }  { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." }  { 2 30 RESERVED R 0 "Reserved.  0s on read." }  } }  { 0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register"   {  { 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" }  { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" }  { 2 30 RESERVED R 0 "Reserved.  0s on read." }  } } {0x10 ap_return R 0x0 "Data signal of ap_return" {{0 16 ap_return R 0 "Bit 15 to 0 Data signal of ap_return"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 reset_A_V W 0x0 "Data signal of reset_A_V" {{0 1 reset_A_V W 0 "Bit 0 to 0 Data signal of reset_A_V"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 reset_V_V W 0x0 "Data signal of reset_V_V" {{0 1 reset_V_V W 0 "Bit 0 to 0 Data signal of reset_V_V"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 reset_params_V W 0x0 "Data signal of reset_params_V" {{0 1 reset_params_V W 0 "Bit 0 to 0 Data signal of reset_params_V"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 athresh W 0x0 "Data signal of athresh" {{0 32 athresh W 0 "Bit 31 to 0 Data signal of athresh"}}} {0x38 vthresh W 0x0 "Data signal of vthresh" {{0 32 vthresh W 0 "Bit 31 to 0 Data signal of vthresh"}}} {0x40 a_flip W 0x0 "Data signal of a_flip" {{0 8 a_flip W 0 "Bit 7 to 0 Data signal of a_flip"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x48 v_flip W 0x0 "Data signal of v_flip" {{0 8 v_flip W 0 "Bit 7 to 0 Data signal of v_flip"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x50 a_length W 0x0 "Data signal of a_length" {{0 32 a_length W 0 "Bit 31 to 0 Data signal of a_length"}}} {0x58 v_length W 0x0 "Data signal of v_length" {{0 32 v_length W 0 "Bit 31 to 0 Data signal of v_length"}}} {0x60 data W 0x0 "Data signal of data" {{0 16 data W 0 "Bit 15 to 0 Data signal of data"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
set enable_xo_gen 0
set kernel_files {/home/greg/everything/xilnx_design/cycle3/src/hls/ratChannel.cpp}
if {$enable_xo_gen} {
